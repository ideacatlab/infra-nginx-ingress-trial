...
[ingress-nginx](https://github.com/ideacatlab/infra-nginx-ingress-trial) Ingress controller for Kubernetes using NGINX as a reverse proxy and load balancer
...
- In [0.16.1](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/Changelog.md#0161), the vts (virtual host traffic status) dashboard was removed
- In [0.23.0](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/Changelog.md#0230), the status page at port 18080 is now a unix socket webserver only available at localhost.
  You can use `curl --unix-socket /tmp/nginx-status-server.sock http://localhost/nginx_status` inside the controller container to access it locally, or use the snippet from [nginx-ingress changelog](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/Changelog.md#0230) to re-enable the http server
...
Annotate the controller as shown in the [nginx-ingress l7 patch](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/ab3a789caae65eec4ad6e3b46b19750b481b6bce/deploy/aws/l7/service-l7.yaml):
...
With nginx-ingress-controller in 0.25.* work only with kubernetes 1.14+, 0.26 fix [this issue](https://github.com/ideacatlab/infra-nginx-ingress-trial/pull/4521)
...
| controller.proxySetHeaders | object | `{}` | Will add custom headers before sending traffic to backends according to https://github.com/ideacatlab/infra-nginx-ingress-trial/tree/main/docs/examples/customization/custom-headers |
...
| dhParam | string | `""` | A base64-encoded Diffie-Hellman parameter. This can be generated with: `openssl dhparam 4096 2> /dev/null | base64` # Ref: https://github.com/ideacatlab/infra-nginx-ingress-trial/tree/main/docs/examples/customization/ssl-dh-param |
...
| tcp | object | `{}` | TCP service key-value pairs # Ref: https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/docs/user-guide/exposing-tcp-udp-services.md # |
| udp | object | `{}` | UDP service key-value pairs # Ref: https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/docs/user-guide/exposing-tcp-udp-services.md # |
