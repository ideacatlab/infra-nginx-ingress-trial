...
In order to overwrite nginx-controller configuration values as seen in [config.go](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/internal/ingress/controller/config/config.go),
...
Sets custom headers from named configmap before sending traffic to the client. See [proxy-set-headers](#proxy-set-headers). [example](https://github.com/ideacatlab/infra-nginx-ingress-trial/tree/main/docs/examples/customization/custom-headers)
...
and must be blocked. Related to [CVE-2021-25742](https://github.com/ideacatlab/infra-nginx-ingress-trial/issues/7837)
...
Activates plugins installed in `/etc/nginx/lua/plugins`. Refer to [ingress-nginx plugins README](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/rootfs/etc/nginx/lua/plugins/README.md) for more information on how to write and install a plugin.
...
DHE-based cyphers will not be available until DH parameter is configured [Custom DH parameters for perfect forward secrecy](https://github.com/ideacatlab/infra-nginx-ingress-trial/tree/main/docs/examples/customization/ssl-dh-param)
...
- ewma: to use the Peak EWMA method for routing ([implementation](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/rootfs/etc/nginx/lua/balancer/ewma.lua))
...
_References:_ [https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/docs/user-guide/nginx-configuration/annotations.md#external-authentication](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/docs/user-guide/nginx-configuration/annotations.md#external-authentication)
...
Configure `memcached` client for [Global Rate Limiting](https://github.com/ideacatlab/infra-nginx-ingress-trial/blob/main/docs/user-guide/nginx-configuration/annotations.md#global-rate-limiting).
